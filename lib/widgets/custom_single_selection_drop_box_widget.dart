...
class CustomSingleSelectionDropBox<T> extends StatefulWidget {
  ...
  const CustomSingleSelectionDropBox(
      {super.key,
      required this.items,
  ...
  @override
  CustomSingleSelectionDropBoxState<T> createState() =>
      CustomSingleSelectionDropBoxState<T>();
}

class CustomSingleSelectionDropBoxState<T>
    extends State<CustomSingleSelectionDropBox<T>>
                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                border: Border.all(
                                    color:
                                        const Color.fromRGBO(128, 32, 179, 1),
                                    width: 1),
                                borderRadius:
